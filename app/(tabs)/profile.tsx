             ...
             <View className="flex-1 z-10">
               <View className="flex-row justify-between items-start mb-1.5">
                 <View className="flex-row items-center flex-1 pr-2">
                   <Text className="text-white font-extrabold text-[17px] mr-1" numberOfLines={1}>{dhoUser.name}</Text>
               ...
               <View className="bg-white/20 border border-white/30 rounded-full px-2.5 py-0.5 self-start mb-3">
                 <Text className="text-white text-[9px] font-bold tracking-widest uppercase">{dhoUser.role}</Text>
               </View>

               <View className="flex-row items-center mb-1">
                 <Feather name="mail" size={10} color="#BFDBFE" className="mr-1.5" />
                 <Text className="text-blue-100 text-[10px] font-semibold">{dhoUser.email}</Text>
               </View>
               <View className="flex-row items-center">
                 <Feather name="map-pin" size={10} color="#BFDBFE" className="mr-1.5" />
                 <Text className="text-blue-100 text-[10px] font-semibold">Devgarh District, Uttar Pradesh</Text>
               </View>
             </View>
          </View>
          ...
          <View className="bg-white rounded-[24px] mx-4 -mt-10 p-3 shadow-sm shadow-black/10 border border-slate-100 flex-row justify-between items-center">
            ...
            <View className="flex-1 flex-row items-center justify-center border-r border-slate-50">
               ...
               <View>
                 ...
                 <Text className="text-brand-navy font-black text-[11px]">DHO</Text>
               </View>
            </View>
            {/* Stat 2 */}
            <View className="flex-1 flex-row items-center justify-center border-r border-slate-50">
               ...
               <View>
                 <Text className="text-slate-400 text-[7px] font-bold">PHCs Managed</Text>
                 <Text className="text-brand-navy font-black text-[11px]">24</Text>
               </View>
            </View>
            {/* Stat 3 */}
            <View className="flex-1 flex-row items-center justify-center border-r border-slate-50">
               ...
               <View>
                 ...
                 <Text className="text-brand-navy font-black text-[11px]">128</Text>
               </View>
            </View>
            {/* Stat 4 */}
            ...
            <View className="flex-row items-center justify-between mb-4">
              <View className="flex-row items-center flex-1">
                ...
                <View className="flex-1 pr-2">
                  <Text className="text-brand-navy font-bold text-[13px] mb-0.5">Translate Console (Hindi)</Text>
                  <Text className="text-slate-500 text-[9px]">View content in Hindi language</Text>
                </View>
              </View>
              <Switch value={hindiLang} onValueChange={setHindiLang} trackColor={{ false: '#E2E8F0', true: '#3B82F6' }} thumbColor="#FFF" />
            </View>
