...
exports.runSimulation = (0, https_1.onCall)(async (request) => {
    const { scenarioName, customParameters } = request.data || {};
    if (!scenarioName) {
        throw new https_1.HttpsError('invalid-argument', 'The function must be called with a scenarioName.');
    }
...
Return a JSON object conforming exactly to this structure:
{
  ...
  "confidenceScore": number
        ...
        throw new https_1.HttpsError('internal', 'Internal simulation execution failed: ' + error.message);
    }
});
