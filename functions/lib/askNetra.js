...
exports.askNetra = (0, https_1.onCall)(async (request) => {
    const { query: queryText, chatHistory } = request.data || {};
    if (!queryText) {
        throw new https_1.HttpsError('invalid-argument', 'The function must be called with a query.');
    }
...
Be concise, professional, and action-oriented. Never output markdown code formats other than standard bolding or bullet points.`;
        ...
        throw new https_1.HttpsError('internal', 'Internal AI query execution failed: ' + error.message);
    }
});
//# sourceMappingURL=askNetra.js.map